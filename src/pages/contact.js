...
export default function Contact({ data }) {
    ...
    return (
        <>
                        <Seo 
                    title="Contact Us | Lions Group"
                    description="Have a question? Please contact us and we would be happy to help."
                />
            <Layout>
                <div>
